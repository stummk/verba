...
const PATHS = {
  ...
  // speech to text: what transcription actually does — a microphone turning
  // into lines of text. A bare microphone means "record", which Verba does not.
  speechToText:
    "M6 3a3 3 0 0 1 3 3v4a3 3 0 0 1-6 0V6a3 3 0 0 1 3-3z"
    + "M11 10a5 5 0 0 1-4 4.9V17h2v2H3v-2h2v-2.1A5 5 0 0 1 1 10h2a3 3 0 0 0 6 0h2z"
  ...
  restore:
    "M13 3c-4.97 0-9 4.03-9 9H1l3.89 3.89.07.14L8.9 12H6c0-3.87 3.13-7 7-7s7 3.13 7 7-3.13 7-7 7c-1.93 0-3.68-.79-4.94-2.06l-1.42 1.42C8.27 19.99 10.51 21 13 21c4.97 0 9-4.03 9-9s-4.03-9-9-9zm-1 5v5l4.28 2.54.72-1.21-3.5-2.08V8H12z",
  refresh:
  ...
  // the overflow menu of a card: the actions that do not fit on it
  moreVert:
  ...
  // a clock, for the running time of a recording
  schedule:
  ...
  // translating: a glyph turning into a letter of another script. The globe
  // below says "some language", which is what the language chip needs — this
  // one says the step that carries a text from one language into another.
  translate:
  ...
  // a calendar with a span marked in it: the date filter is a range, not a day
  dateRange:
    "M19 4h-1V2h-2v2H8V2H6v2H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2z"
    + "M19 20H5V10h14v10zM5 8V6h14v2H5z"
    + "M7 12h5v2H7zM7 15h9v2H7z",
  // a filter funnel: the row of tag filters as a whole
  filter: "M10 18h4v-2h-4v2zM3 6v2h18V6H3zm3 7h12v-2H6v2z",
  // one month back and forth in the calendar of the date filter
